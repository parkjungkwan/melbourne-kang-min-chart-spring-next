import { fetchArticleAPI, writeArticleApi } from "modules/apis/board/createArticleApi";
import { Article, ArticleActions, writeBoard, writeBoardFailure, writeBoardSuccess } from "modules/board/readArticle";
